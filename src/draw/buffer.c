...
int giftag_ad_prim(struct d2d_state *s, int type, int shaded, int textured,
                   int aa) {
...
int giftag_ad_tex0(struct d2d_state *s, int reg, int tbp, int tbw, int psm,
...
int giftag_ad_tex1(struct d2d_state *s, int lcm, int mxl, int mtba, int l,
                   int k) {
...
int giftag_ad_tex2(struct d2d_state *s, int psm, int cbp, int cpsm, int csm,
                   int csa, int cld) {
